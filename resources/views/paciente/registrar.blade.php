        ...
        <div class="relative overflow-x-auto">
            <div class="container mx-auto p-8 bg-gray-800 text-white rounded-lg shadow-lg"> <!-- Ajustado p-4 a p-8 para más espacio interno -->
                ...
                <form class="max-w-2xl mx-auto" method="POST" action="{{route('registro_paciente')}}"> <!-- Ajustado max-w-md a max-w-2xl para mayor ancho -->
                    ...
                    <button type="submit" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Registrar</button>
                </form>
            </div>
        </div>
    </div>
